...
@implementation V1templateApi
static NSString * basePath = @"http://null/";

+(V1templateApi*) apiWithHeader:(NSString*)headerValue key:(NSString*)key {
    static V1templateApi* singletonAPI = nil;

    if (singletonAPI == nil) {
        singletonAPI = [[V1templateApi alloc] init];
...
-(NSNumber*) findTemplatesByUserWithCompletionBlock: (NSString*) userCode
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/v1/template/list/{userCode}", basePath];
...
-(NSNumber*) findTemplateByCodeWithCompletionBlock: (NSString*) code
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/v1/template/{code}", basePath];
    ...
    return [client dictionary: requestUrl 
          ...
          responseContentType: responseContentType
              completionBlock: ^(NSDictionary *data, NSError *error) {
                ...
                Template *result = nil;
                if (data) {
                    result = [[Template    alloc]initWithValues: data];
                }
