...
+(NSNumber*) getSignatureAuditById: (NSString*) signatureCode
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/v3/audit/signature/{signatureCode}", [[ApiClient sharedInstance] url]];
    ...
    return [client dictionary: auth
          ...
          responseContentType: responseContentType
              successBlock: ^(NSDictionary *data) {
                ...
                MSAuditoryInfo *result = nil;
                if (data) {
                    result = [[MSAuditoryInfo    alloc]initWithValues: data];
                }
...
+(NSNumber*) getAuditTrailByCode: (NSString*) messageCode
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/v3/audit/{messageCode}", [[ApiClient sharedInstance] url]];
    ...
    return [client dictionary: auth
          ...
          responseContentType: responseContentType
              successBlock: ^(NSDictionary *data) {
                ...
                MSAuditTrail *result = nil;
                if (data) {
                    result = [[MSAuditTrail    alloc]initWithValues: data];
                }
                onSuccessBlock(result);
