...
+(NSNumber*) requestToken: 
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/v3/oauth/requestToken", [[ApiClient sharedInstance] url]];
