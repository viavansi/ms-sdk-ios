...
+(NSNumber*) getAllGroups:(OAuth1Client *) auth onSuccess: 
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/v3/groups/all", [[ApiClient sharedInstance] url]];
...
+(NSNumber*) createGroup: (MSGroup*) body
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/v3/groups/new", [[ApiClient sharedInstance] url]];
...
+(NSNumber*) createGroupByParentGroup: (MSGroup*) body
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/v3/groups/new/{parentGroupCode}", [[ApiClient sharedInstance] url]];
    ...
    [requestUrl replaceCharactersInRange: [requestUrl rangeOfString:[NSString stringWithFormat:@"%@%@%@", @"{", @"parentGroupCode", @"}"]] withString: [ApiClient escape:parentGroupCode]];
...
+(NSNumber*) getGroupCustomizationNotification: (NSString*) groupCode
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/v3/groups/notifications/{groupCode}", [[ApiClient sharedInstance] url]];
...
+(NSNumber*) getSignPageStyleDefault:(OAuth1Client *) auth onSuccess: 
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/v3/groups/style", [[ApiClient sharedInstance] url]];
...
+(NSNumber*) updateGroup: (MSGroupInfo*) body
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/v3/groups/update", [[ApiClient sharedInstance] url]];
    ...
    return [client dictionary: auth
          ...
          responseContentType: responseContentType
              successBlock: ^(NSDictionary *data) {
                ...
                MSGroupInfo *result = nil;
                if (data) {
                    result = [[MSGroupInfo    alloc]initWithValues: data];
                }
                onSuccessBlock(result);
