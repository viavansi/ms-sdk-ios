...
+(NSNumber*) findAllTemplatesByUserAndGroup: (NSString*) groupCode
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/v3/template/all/{groupCode}/{userCode}", [[ApiClient sharedInstance] url]];
...
+(NSNumber*) findTemplatesByUserAndGroupWithFormAndTemplate: (NSString*) groupCode
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/v3/template/allComplete/{groupCode}/{userCode}", [[ApiClient sharedInstance] url]];
...
+(NSNumber*) findMyTemplates:(OAuth1Client *) auth onSuccess: 
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/v3/template/list/mine", [[ApiClient sharedInstance] url]];
...
+(NSNumber*) findMyGroupTemplates: (NSString*) groupCode
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/v3/template/list/mine/{groupCode}", [[ApiClient sharedInstance] url]];
...
+(NSNumber*) findPolicyTemplatesByUser: (NSString*) userCode
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/v3/template/policies/{userCode}", [[ApiClient sharedInstance] url]];
...
+(NSNumber*) findWacomByUser: (NSString*) userCode
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/v3/template/wacom/{userCode}", [[ApiClient sharedInstance] url]];
