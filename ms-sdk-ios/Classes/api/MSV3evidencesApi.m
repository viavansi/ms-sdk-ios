...
+(NSNumber*) attach: (NSString*) messageCode
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/v3/evidences/attach", [[ApiClient sharedInstance] url]];
    ...
    if(attachmentCode){
    formParams[@"attachmentCode"] = attachmentCode;
    }
    
    requestContentType = @"multipart/form-data";
    [bodyDictionary addObject:attachmentFile];
    attachmentFile.paramName  = @"attachmentFile";
    ...
    return [client dictionary: auth
          ...
          responseContentType: responseContentType
              successBlock: ^(NSDictionary *data) {
                ...
                MSAttachment *result = nil;
                if (data) {
                    result = [[MSAttachment    alloc]initWithValues: data];
                }
...
+(NSNumber*) getAttachmentData: (NSString*) messageCode
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/v3/evidences/attachment/{messageCode}/{attachmentCode}", [[ApiClient sharedInstance] url]];
    ...
    [requestUrl replaceCharactersInRange: [requestUrl rangeOfString:[NSString stringWithFormat:@"%@%@%@", @"{", @"attachmentCode", @"}"]] withString: [ApiClient escape:attachmentCode]];
    ...
    return [client dictionary: auth
          ...
          responseContentType: responseContentType
              successBlock: ^(NSDictionary *data) {
                ...
                MSAttachmentFile *result = nil;
                if (data) {
                    result = [[MSAttachmentFile    alloc]initWithValues: data];
                }
                onSuccessBlock(result);
...
+(NSNumber*) getAttachmentFile: (NSString*) messageCode
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/v3/evidences/attachmentFile/{messageCode}/{attachmentCode}", [[ApiClient sharedInstance] url]];
    ...
    NSArray * responseContentTypes = @[@"application/octet-stream"];
    NSString* responseContentType = responseContentTypes.count > 0 ? responseContentTypes[0] : @"application/json";
...
+(NSNumber*) getEvidenceData: (NSString*) messageCode
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/v3/evidences/data/{messageCode}/{evidenceCode}", [[ApiClient sharedInstance] url]];
...
+(NSNumber*) addGenericListAsEvidence: (NSArray*) body
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/v3/evidences/genericList", [[ApiClient sharedInstance] url]];
...
+(NSNumber*) getOTPGroupEvidences: (NSString*) setCode
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/v3/evidences/otp/group/{setCode}", [[ApiClient sharedInstance] url]];
    ...
    return [client dictionary: auth
          ...
          responseContentType: responseContentType
              successBlock: ^(NSDictionary *data) {
                ...
                MSOtpList *result = nil;
                if (data) {
                    result = [[MSOtpList    alloc]initWithValues: data];
                }
                onSuccessBlock(result);
...
+(NSNumber*) prepareBatchOtpMailEvidence: (NSString*) setCode
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/v3/evidences/otp/mail/prepare/batch/{setCode}/{groupCode}", [[ApiClient sharedInstance] url]];
...
+(NSNumber*) prepareOtpMailEvidence: (NSString*) messageCode
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/v3/evidences/otp/mail/prepare/{messageCode}/{evidenceCode}", [[ApiClient sharedInstance] url]];
...
+(NSNumber*) validateOtpMailEvidence: (NSString*) messageCode
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/v3/evidences/otp/mail/validate", [[ApiClient sharedInstance] url]];
...
+(NSNumber*) validateBatchOtpMailEvidence: (NSString*) setCode
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/v3/evidences/otp/mail/validate/batch", [[ApiClient sharedInstance] url]];
    ...
    if(groupCode){
    formParams[@"groupCode"] = groupCode;
    }
...
+(NSNumber*) prepareBatchOtpSmsEvidence: (NSString*) setCode
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/v3/evidences/otp/sms/prepare/batch/{setCode}/{groupCode}", [[ApiClient sharedInstance] url]];
...
+(NSNumber*) prepareValidationOtpSmsEvidence: (NSString*) operationCode
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/v3/evidences/otp/sms/prepare/validate/{operationCode}/{setCode}/{groupCode}", [[ApiClient sharedInstance] url]];
    ...
    [requestUrl replaceCharactersInRange: [requestUrl rangeOfString:[NSString stringWithFormat:@"%@%@%@", @"{", @"operationCode", @"}"]] withString: [ApiClient escape:operationCode]];
    [requestUrl replaceCharactersInRange: [requestUrl rangeOfString:[NSString stringWithFormat:@"%@%@%@", @"{", @"setCode", @"}"]] withString: [ApiClient escape:setCode]];
    [requestUrl replaceCharactersInRange: [requestUrl rangeOfString:[NSString stringWithFormat:@"%@%@%@", @"{", @"groupCode", @"}"]] withString: [ApiClient escape:groupCode]];
...
+(NSNumber*) validateBatchOtpSmsEvidence: (NSString*) setCode
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/v3/evidences/otp/sms/validate/batch", [[ApiClient sharedInstance] url]];
...
+(NSNumber*) removeEvidence: (NSString*) messageCode
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/v3/evidences/remove/{messageCode}/{evidenceCode}", [[ApiClient sharedInstance] url]];
...
+(NSNumber*) removeAttachment: (NSString*) messageCode
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/v3/evidences/removeAttachment/{messageCode}/{attachmentCode}", [[ApiClient sharedInstance] url]];
...
+(NSNumber*) sendSmsChangePassword: (NSString*) userCode
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/v3/evidences/sms/reset/password/{userCode}", [[ApiClient sharedInstance] url]];
...
+(NSNumber*) getEvidenceStatus: (NSString*) messageCode
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/v3/evidences/status/{messageCode}/{evidenceCode}", [[ApiClient sharedInstance] url]];
