#import "MSV3signerWorkflowApi.h"
#import "SWGFile.h"
#import "ApiClient.h"
...
@implementation MSV3signerWorkflowApi
...
+(NSNumber*) save: (MSSignerWorkflow*) body
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/v3/signerWorkflow", [[ApiClient sharedInstance] url]];
    ...
    return [client dictionary: auth
          ...
          responseContentType: responseContentType
              successBlock: ^(NSDictionary *data) {
                ...
                MSSignerWorkflow *result = nil;
                if (data) {
                    result = [[MSSignerWorkflow    alloc]initWithValues: data];
                }
...
+(NSNumber*) getSignerWorkflowByUser: (NSString*) userCode
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/v3/signerWorkflow/list/{userCode}/{groupCode}", [[ApiClient sharedInstance] url]];
              ...
              successBlock: ^(NSDictionary *data){
                if([data isKindOfClass:[NSArray class]]){
                    ...
                    for (NSDictionary* dict in (NSArray*)data) {
                        ...
                        MSSignerWorkflow* d = [[MSSignerWorkflow alloc]initWithValues: dict];
...
+(NSNumber*) removeSignerWorkflow: (NSString*) code
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/v3/signerWorkflow/remove/{code}/{userCode}/{groupCode}", [[ApiClient sharedInstance] url]];
