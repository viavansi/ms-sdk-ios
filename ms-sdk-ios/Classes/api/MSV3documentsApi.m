...
+(NSNumber*) downloadSignedByExternaCode: (NSString*) externalCode
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/v3/documents/download/signed/external/code/{externalCode}", [[ApiClient sharedInstance] url]];
...
+(NSNumber*) downloadAuditTrailWithLanguageId: (NSString*) messageCode
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/v3/documents/download/trail/{messageCode}/{languageId}", [[ApiClient sharedInstance] url]];
    ...
    [requestUrl replaceCharactersInRange: [requestUrl rangeOfString:[NSString stringWithFormat:@"%@%@%@", @"{", @"messageCode", @"}"]] withString: [ApiClient escape:messageCode]];
    [requestUrl replaceCharactersInRange: [requestUrl rangeOfString:[NSString stringWithFormat:@"%@%@%@", @"{", @"languageId", @"}"]] withString: [ApiClient escape:languageId]];
