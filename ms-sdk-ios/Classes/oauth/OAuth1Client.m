...
- (NSString *) hmacSha1Signature:(NSURLRequest *)request oauthParameters:(NSString *)oauthParameters
{
	...
	if([contentType isEqualToString:@"application/x-www-form-urlencoded"]){
		...
		requestStringOrdered = AFPercentEscapedQueryStringPairMemberFromStringWithEncoding(requestStringOrdered, NSUTF8StringEncoding);
		NSString *requestStringConcat = [NSString stringWithFormat:@"%@&%@", requestString, requestStringOrdered];
